...
import { portfolioCommands } from "../../types/portfolio";
        ...
        {portfolioCommands.map((command) => {
          ...
          return (
            <button
              ...
              className={`group relative inline-flex items-center gap-2 rounded-lg border px-3 py-1.5 font-mono text-xs font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/50 focus-visible:ring-offset-1 focus-visible:ring-offset-[#0c0c0e] ${
                isCommandRunning
