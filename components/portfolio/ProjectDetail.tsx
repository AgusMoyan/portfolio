...
function DetailBlock({
  ...
  return (
    <section className="space-y-2">
      <h4 className="font-mono text-[11px] font-semibold uppercase tracking-[0.18em] text-zinc-500">
        {title}
      </h4>
      {children}
    </section>
...
export default function ProjectDetail({ project }: ProjectDetailProps) {
  ...
  return (
    <motion.article
      ...
      className="min-w-0 rounded-2xl border border-zinc-200 bg-white p-4 text-left shadow-sm sm:p-5"
    >
      <header className="border-b border-zinc-100 pb-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <h3 className="mt-1 break-words text-xl font-bold tracking-tight text-zinc-950">
              {project.name}
            </h3>
